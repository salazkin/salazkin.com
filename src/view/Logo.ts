...
export class Logo {
  constructor() {
    ...
    const logo = document.createElementNS("http://www.w3.org/2000/svg", "path");
    logo.setAttributeNS(null, "fill", getColorStr(logoColor, logoAlpha));
    logo.setAttributeNS(
      null,
      "d",
    ...
    logo.setAttributeNS(null, "transform", `translate(${logoPos.x} ${logoPos.y})`);
    document.getElementById("main-svg").appendChild(logo);
  }
}
